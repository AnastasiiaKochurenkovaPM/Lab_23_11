...
// Відобразити дані про усі поїзди
...
// Відобразити дані про усіх пасажирів
...
// Відобразити дані про усі квитки
...
function modal_delete_soldTickets() {

   modal_confirm_create("Видалення даних",
                        "Ви дійсно хочете видалити усі наявні дані про продані квитки?",
                        "Очистити",
                        "Відміна",
                        "delete_soldTickets");
