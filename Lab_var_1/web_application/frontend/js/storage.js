...
async function server_PUT (req, array) {
   ...
   switch (req) {
      ...
      case "/set_soldTickets": collection = 4; break;
...
function save_data_in_data_base() {
   ...
   switch (target) {
      ...
      case "tickets":
         ...
         server_PUT("/set_soldTickets", get_soldTickets_list(true));
         break;

      case "soldTickets":
         server_PUT("/set_soldTickets", get_tickets_list(true));
         break;
...
async function load_data_from_local_storage() {
   ...
   switch (target) {
      ...
      case "tickets":
         ...
         item = JSON.parse(localStorage.getItem("soldTickets"));
